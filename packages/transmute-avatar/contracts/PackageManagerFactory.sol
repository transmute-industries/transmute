...
contract PackageManagerFactory is UnsafeEventStore {
  ...
  // Constructor
  function PackageManagerFactory() public
  payable
  {
    ...
    returns (address)
  {
	...
	PackageManager _newEventStore = new PackageManager();
