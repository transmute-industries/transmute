...
export class EventStoreLib extends SoltsiceContract {
  static get Artifacts() {
    return require('../../node_modules/transmute-contracts/build/contracts/EventStoreLib.json')
  }
  ...
  protected constructor(
    ...
    // tslint:disable-next-line:max-line-length
    super(w3, EventStoreLib.Artifacts, ctorParams ? [] : [], deploymentParams, link)
  }
  /*
        Contract methods
    */
  ...
  public writeEvent = Object.assign(
    ...
    },
    {
      ...
      data: (
        ...
        return new Promise((resolve, reject) => {
          resolve(
            this._instance.writeEvent.request(self, _eventType, _keyType, _valueType, _key, _value)
              .params[0].data
          )
        })
      }
    },
    {
      ...
      estimateGas: (
        ...
        return new Promise((resolve, reject) => {
          this._instance.writeEvent
            .estimateGas(self, _eventType, _keyType, _valueType, _key, _value)
            .then(g => resolve(g))
        })
      }
    }
