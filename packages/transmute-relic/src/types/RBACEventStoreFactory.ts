...
export class RBACEventStoreFactory extends SoltsiceContract {
    static get Artifacts() { return require('../../node_modules/transmute-contracts/build/contracts/RBACEventStoreFactory.json'); }
    ...
    static async New(deploymentParams: W3.TC.TxParams, ctorParams?: {}, w3?: W3, link?: SoltsiceContract[]): Promise<RBACEventStoreFactory> {
    ...
    protected constructor(
        ...
        super(
            w3,
            RBACEventStoreFactory.Artifacts,
            ctorParams ? [] : [],
            deploymentParams,
            link
        );
