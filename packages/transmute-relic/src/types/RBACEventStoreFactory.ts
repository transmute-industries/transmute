...
/**
 * RBACEventStoreFactory API
 */
export class RBACEventStoreFactory extends SoltsiceContract {
  static get Artifacts() {
    return require('../../node_modules/transmute-contracts/build/contracts/RBACEventStoreFactory.json')
  }

  static get BytecodeHash() {
    // we need this before ctor, but artifacts are static and we cannot pass it to the base class, so need to generate
    let artifacts = RBACEventStoreFactory.Artifacts
  ...
  ): Promise<RBACEventStoreFactory> {
    let contract = new RBACEventStoreFactory(deploymentParams, ctorParams, w3, link)
    await contract._instancePromise
    return contract
  }

  static async At(address: string | object, w3?: W3): Promise<RBACEventStoreFactory> {
    let contract = new RBACEventStoreFactory(address, undefined, w3, undefined)
    await contract._instancePromise
    return contract
  }
  ...
  protected constructor(
    ...
    // tslint:disable-next-line:max-line-length
    super(w3, RBACEventStoreFactory.Artifacts, ctorParams ? [] : [], deploymentParams, link)
  }
  /*
        Contract methods
    */
  ...
  public createEventStore = Object.assign(
    ...
    (txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
      return new Promise((resolve, reject) => {
        this._instance
          .createEventStore(txParams || this._sendParams)
          .then(res => resolve(res))
          .catch(err => reject(err))
      })
    },
  ...
  public setGrant = Object.assign(
    ...
    (
      ...
      return new Promise((resolve, reject) => {
        this._instance
          .setGrant(role, resource, action, attributes, txParams || this._sendParams)
          .then(res => resolve(res))
          .catch(err => reject(err))
      })
    },
    {
      ...
      sendTransaction: (
        ...
        return new Promise((resolve, reject) => {
          this._instance.setGrant
            .sendTransaction(role, resource, action, attributes, txParams || this._sendParams)
            .then(res => resolve(res))
            .catch(err => reject(err))
        })
      }
    },
    {
      ...
      data: (
        ...
        return new Promise((resolve, reject) => {
          resolve(
            this._instance.setGrant.request(role, resource, action, attributes).params[0].data
          )
        })
      }
    },
    {
      ...
      estimateGas: (
        ...
        return new Promise((resolve, reject) => {
          this._instance.setGrant
            .estimateGas(role, resource, action, attributes)
            .then(g => resolve(g))
        })
      }
    }
  ...
  public killEventStore = Object.assign(
    ...
    (_address: string, txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
      return new Promise((resolve, reject) => {
        this._instance
          .killEventStore(_address, txParams || this._sendParams)
          .then(res => resolve(res))
          .catch(err => reject(err))
      })
    },
    {
      ...
      sendTransaction: (_address: string, txParams?: W3.TC.TxParams): Promise<string> => {
        return new Promise((resolve, reject) => {
          this._instance.killEventStore
            .sendTransaction(_address, txParams || this._sendParams)
            .then(res => resolve(res))
            .catch(err => reject(err))
        })
      }
  ...
  public setAddressRole = Object.assign(
    ...
    (target: string, role: string, txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
      return new Promise((resolve, reject) => {
        this._instance
          .setAddressRole(target, role, txParams || this._sendParams)
          .then(res => resolve(res))
          .catch(err => reject(err))
      })
    },
    {
      ...
      sendTransaction: (
        ...
        return new Promise((resolve, reject) => {
          this._instance.setAddressRole
            .sendTransaction(target, role, txParams || this._sendParams)
            .then(res => resolve(res))
            .catch(err => reject(err))
        })
      }
