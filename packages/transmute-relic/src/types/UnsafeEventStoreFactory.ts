...
export class UnsafeEventStoreFactory extends SoltsiceContract {
  static get Artifacts() {
    return require('../../node_modules/transmute-contracts/build/contracts/UnsafeEventStoreFactory.json')
  }
  ...
  ): Promise<UnsafeEventStoreFactory> {
  ...
  protected constructor(
    ...
    // tslint:disable-next-line:max-line-length
    super(w3, UnsafeEventStoreFactory.Artifacts, ctorParams ? [] : [], deploymentParams, link)
  }
  /*
        Contract methods
    */
