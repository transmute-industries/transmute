...
export class AddressSetSpec extends SoltsiceContract {
    static get Artifacts() { return require('../../node_modules/transmute-contracts/build/contracts/AddressSetSpec.json'); }
    ...
    static async New(deploymentParams: W3.TC.TxParams, ctorParams?: {}, w3?: W3, link?: SoltsiceContract[]): Promise<AddressSetSpec> {
        let contract = new AddressSetSpec(deploymentParams, ctorParams, w3, link);
        await contract._instancePromise;
        return contract;
    }

    static async At(address: string | object, w3?: W3): Promise<AddressSetSpec> {
    ...
    */
    ...
    public add = Object.assign(
        ...
        (value: string, txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
        ...
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            sendTransaction: (value: string, txParams?: W3.TC.TxParams): Promise<string> => {
                return new Promise((resolve, reject) => {
    ...
    // tslint:disable-next-line:max-line-length
    // tslint:disable-next-line:variable-name
    public getValues( txParams?: W3.TC.TxParams): Promise<string[]> {
        return new Promise((resolve, reject) => {
    ...
    public set = Object.assign(
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        (index: BigNumber | number, value: string, txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
            return new Promise((resolve, reject) => {
        ...
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            sendTransaction: (index: BigNumber | number, value: string, txParams?: W3.TC.TxParams): Promise<string> => {
                return new Promise((resolve, reject) => {
    ...
    // tslint:disable-next-line:max-line-length
    // tslint:disable-next-line:variable-name
    public first( txParams?: W3.TC.TxParams): Promise<string> {
        return new Promise((resolve, reject) => {
    ...
    // tslint:disable-next-line:max-line-length
    // tslint:disable-next-line:variable-name
    public last( txParams?: W3.TC.TxParams): Promise<string> {
        return new Promise((resolve, reject) => {
            this._instance.last
                .call( txParams || this._sendParams)
                .then((res) => resolve(res))
    ...
    // tslint:disable-next-line:max-line-length
    // tslint:disable-next-line:variable-name
    public contains(value: string, txParams?: W3.TC.TxParams): Promise<boolean> {
        return new Promise((resolve, reject) => {
    ...
    // tslint:disable-next-line:max-line-length
    // tslint:disable-next-line:variable-name
    public lastPop( txParams?: W3.TC.TxParams): Promise<string> {
        return new Promise((resolve, reject) => {
    ...
    // tslint:disable-next-line:max-line-length
    // tslint:disable-next-line:variable-name
    public get(index: BigNumber | number, txParams?: W3.TC.TxParams): Promise<string> {
        return new Promise((resolve, reject) => {
            this._instance.get
    ...
    // tslint:disable-next-line:max-line-length
    // tslint:disable-next-line:variable-name
    public indexOf(value: string, txParams?: W3.TC.TxParams): Promise<BigNumber> {
        return new Promise((resolve, reject) => {
