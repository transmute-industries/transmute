...
export class EventStoreFactory extends SoltsiceContract {
    static get Artifacts() { return require('../../node_modules/transmute-contracts/build/contracts/EventStoreFactory.json'); }
    ...
    static async New(deploymentParams: W3.TC.TxParams, ctorParams?: {}, w3?: W3, link?: SoltsiceContract[]): Promise<EventStoreFactory> {
    ...
    */
    ...
    public creator( txParams?: W3.TC.TxParams): Promise<string> {
    ...
    public writeEvent = Object.assign(
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        (_eventType: string, _keyType: string, _valueType: string, _key: string, _value: string, txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
            return new Promise((resolve, reject) => {
        ...
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            sendTransaction: (_eventType: string, _keyType: string, _valueType: string, _key: string, _value: string, txParams?: W3.TC.TxParams): Promise<string> => {
                return new Promise((resolve, reject) => {
    ...
    public createEventStore = Object.assign(
        ...
        ( txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
            return new Promise((resolve, reject) => {
                this._instance.createEventStore( txParams || this._sendParams)
                    .then((res) => resolve(res))
                    .catch((err) => reject(err));
            });
        },
        {
            ...
            sendTransaction: ( txParams?: W3.TC.TxParams): Promise<string> => {
                return new Promise((resolve, reject) => {
                    this._instance.createEventStore.sendTransaction( txParams || this._sendParams)
                        .then((res) => resolve(res))
                        .catch((err) => reject(err));
                });
            }
        },
        {
            ...
            data: (): Promise<string> => {
                return new Promise((resolve, reject) => {
                    resolve(this._instance.createEventStore.request().params[0].data);
                });
            }
        },
        {
            ...
            estimateGas: (): Promise<number> => {
                return new Promise((resolve, reject) => {
                    this._instance.createEventStore.estimateGas().then((g) => resolve(g));
                });
            }
        });
    ...
    // tslint:disable-next-line:member-ordering
    public setEventStoreWhitelist = Object.assign(
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        (_eventStoreAddress: string, _whitelist: string[], txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
            return new Promise((resolve, reject) => {
                this._instance.setEventStoreWhitelist(_eventStoreAddress, _whitelist, txParams || this._sendParams)
                    .then((res) => resolve(res))
                    .catch((err) => reject(err));
            });
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            sendTransaction: (_eventStoreAddress: string, _whitelist: string[], txParams?: W3.TC.TxParams): Promise<string> => {
                return new Promise((resolve, reject) => {
                    this._instance.setEventStoreWhitelist.sendTransaction(_eventStoreAddress, _whitelist, txParams || this._sendParams)
                        .then((res) => resolve(res))
                        .catch((err) => reject(err));
                });
            }
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            data: (_eventStoreAddress: string, _whitelist: string[]): Promise<string> => {
                return new Promise((resolve, reject) => {
                    resolve(this._instance.setEventStoreWhitelist.request(_eventStoreAddress, _whitelist).params[0].data);
                });
            }
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            estimateGas: (_eventStoreAddress: string, _whitelist: string[]): Promise<number> => {
                return new Promise((resolve, reject) => {
                    this._instance.setEventStoreWhitelist.estimateGas(_eventStoreAddress, _whitelist).then((g) => resolve(g));
                });
            }
        });
    
    // tslint:disable-next-line:member-ordering
    public killEventStore = Object.assign(
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        (_eventStoreAddress: string, txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
            return new Promise((resolve, reject) => {
                this._instance.killEventStore(_eventStoreAddress, txParams || this._sendParams)
                    .then((res) => resolve(res))
                    .catch((err) => reject(err));
            });
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            sendTransaction: (_eventStoreAddress: string, txParams?: W3.TC.TxParams): Promise<string> => {
                return new Promise((resolve, reject) => {
                    this._instance.killEventStore.sendTransaction(_eventStoreAddress, txParams || this._sendParams)
                        .then((res) => resolve(res))
                        .catch((err) => reject(err));
                });
            }
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            data: (_eventStoreAddress: string): Promise<string> => {
                return new Promise((resolve, reject) => {
                    resolve(this._instance.killEventStore.request(_eventStoreAddress).params[0].data);
                });
            }
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            estimateGas: (_eventStoreAddress: string): Promise<number> => {
                return new Promise((resolve, reject) => {
                    this._instance.killEventStore.estimateGas(_eventStoreAddress).then((g) => resolve(g));
                });
            }
        });
