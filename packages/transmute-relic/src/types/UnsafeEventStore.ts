...
export class UnsafeEventStore extends SoltsiceContract {
  static get Artifacts() {
    return require('../../node_modules/transmute-contracts/build/contracts/UnsafeEventStore.json')
  }
  ...
  protected constructor(
    ...
    // tslint:disable-next-line:max-line-length
    super(w3, UnsafeEventStore.Artifacts, ctorParams ? [] : [], deploymentParams, link)
  }
  /*
        Contract methods
    */
