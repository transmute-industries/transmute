...
import { EventStoreFactory, EventStore, StreamModel } from 'transmute-eventstore';
...
class DocumentsPage extends Component {
  ...
  onResetDemo = async (event) => {
    ...
    this.props.history.push('/transmute/eventstore/' + lastItem + '/documents');
  ...
  render() {
    ...
    return (
      <AppBar>
        <Button color="secondary" onClick={() => this.onResetDemo()}>
          Reset Demo
        </Button>
