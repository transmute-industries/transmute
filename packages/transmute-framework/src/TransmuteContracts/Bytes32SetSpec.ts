...
export class Bytes32SetSpec extends SoltsiceContract {
    public static get Artifacts() { return require('../contracts/Bytes32SetSpec.json'); }
    ...
    public static async New(deploymentParams: W3.TX.TxParams, ctorParams?: {}, w3?: W3, link?: SoltsiceContract[], privateKey?: string): Promise<Bytes32SetSpec> {
        w3 = w3 || W3.Default;
        if (!privateKey) {
    ...
    public static async At(address: string | object, w3?: W3): Promise<Bytes32SetSpec> {
    ...
    public static NewData(ctorParams?: {}, w3?: W3): string {
        // tslint:disable-next-line:max-line-length
        let data = SoltsiceContract.NewDataImpl(w3, Bytes32SetSpec.Artifacts, ctorParams ? [] : []);
        return data;
    }
