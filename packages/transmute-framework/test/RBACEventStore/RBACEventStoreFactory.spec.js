...
var RBACEventStoreFactory = artifacts.require(
  './TransmuteFramework/EventStore/Bases/RBACEventStoreFactory/RBACEventStoreFactory.sol'
)
var RBACEventStore = artifacts.require('./TransmuteFramework/EventStore/Bases/RBACEventStoreFactory/RBACEventStore.sol')

var _ = require('lodash')

const { getFSAFromEventArgs, getFSAFromEventValues, isVmException, grantItemFromEvent } = require('../Common')
